    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="Brainwave unlock the potential of AI-powered appliction"
        />
            ...
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                ...
                <p className="body-3 mb-[3rem] text-n-3">
                  Automatically enchance your photo using our AI app's photo
                  editing feature. Try it now!
                </p>
              </div>
              <PhotoChatMessage />
            </div>
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-n-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                <h4 className="h-4 mb-4">Video generation</h4>
                <p className="body-2 mb-[2rem] text-n-3">
                  The world's most powerful AI photos and video art generation
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <img src={service3} alt="service icon" className="w-full h-full object-cover" width={520} height={400}/>
                <VideoChatMessage/>
                <VideoBar/>
              </div>
            </div>
